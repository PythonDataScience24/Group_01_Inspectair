...
class TestAqi(unittest.TestCase):
    def test_calculate_aqi(self):
        self.assertEqual(calculate_aqi("no2",[78,217]),[77,123])
        self.assertEqual(calculate_aqi("pm25",[35.4]),[100])
        self.assertEqual(calculate_aqi("pm25",[-22]),[0])
        self.assertEqual(calculate_aqi("pm10",[177]),[112])
